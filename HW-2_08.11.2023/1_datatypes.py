...
#           0      1   2      3           4
#            -5      -4    -3   -2        -1
list1 = ["Python", 2, 2.5, b"Python", [1, 2, 3]]  # список - коллекция элементов
list2 = []
tmp1 = 'Python'
tmp2 = 2
# print(list1[4][1])
...
print(list1)
list1.pop(0)  #метод удаления по индексу
print(list1)


#        0     1
tuple = (12, False)  #кортеж - коллекция неизменяемых элементов
tuple = (12, )  #кортеж - коллекция с одним элементом

set1 = {12, False, 12, 12, 12} # множество - коллеккция уникальных элеменов
print(set1)
